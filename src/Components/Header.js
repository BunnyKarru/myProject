  ...
  return (
    ...
    <div className="container mx-auto flex justify-between items-center py-3 px-6">
      <div
        ...
        onClick={() => navigate("/")}
      >
        <p className="text-white text-3xl font-bold hidden sm:inline">
          Trave
        </p>
        <p className="text-3xl text-gray-900 font-bold hidden sm:inline">
          Lore
        </p>
      </div>
      <div className="flex items-center">
        <div className="md:ml-auto sm:mr-auto">
          <input
            type="text"
            id="search-bar"
            placeholder="Search..."
            className="bg-white border border-gray-400 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={countryName}
